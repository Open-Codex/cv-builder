...
const THEME_LANGUAGES = ['english', 'spanish'];
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="bg-[#3d3d3d] text-gray-200 text-sm rounded border border-[#555] px-1.5 py-1.5 focus:outline-none focus:ring-1 focus:ring-blue-500 appearance-none pr-7 relative w-24"
